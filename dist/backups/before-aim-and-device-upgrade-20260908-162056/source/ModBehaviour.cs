...
namespace DuckovPad
{
    ...
    public sealed class ModBehaviour : Duckov.Modding.ModBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            var rect = new Rect(12f, 12f, width, 176f);
            ...
            var pad = Pad.Current;
            string device = pad == null ? "none" : pad.displayName;
            ...
            if (_aim != null)
            {
                text +=
                    ...
                    "  pull: " + _aim.AssistWeight.ToString("0.00") +
        ...
        {
            if (!Active || control == null) return true;
