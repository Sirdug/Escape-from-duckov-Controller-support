...
namespace DuckovPad
{
    ...
    internal static class PadSettingsLayout
    {
        ...
        public static void Build(Transform container, PadConfig config, TMP_FontAsset font)
        {
            ...
            var help = Row(container, "ControllerHelp", 64f);
            Text(help.transform, font,
                "Open a section to customize your controller. Changes save automatically.\n" +
                "A: select / change   |   Left / right: adjust sliders   |   Right stick: scroll",
                0.015f, 0.985f, 19f);
            ...
            Text(bindHelp.transform, font,
                "BUTTON MAPPING\nSelect a binding, then press a button. Hold LB for a combo. B cancels; Delete clears.",
                0.015f, 0.985f, 19f);
