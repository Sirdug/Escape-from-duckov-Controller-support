...
namespace DuckovPad
{
    ...
    internal static class PadOptions
    {
        ...
        private static readonly string[] AimModes = { "Twin-stick (absolute)", "Cursor (relative)" };
        ...
        public static readonly List<PadOption> All = new List<PadOption>
        {
            ...
            new PadOption
            {
                ...
                Choices = AimModes,
                GetChoice = c => string.Equals(c.Aim.Mode, "relative", StringComparison.OrdinalIgnoreCase) ? 1 : 0,
                SetChoice = (c, i) => c.Aim.Mode = i == 1 ? "relative" : "absolute"
            },
            new PadOption
            {
            ...
            new PadOption
            {
                Section = "Lock-on", Key = Prefix + "LockOn", Label = "Lock-on (press R3)", Kind = OptionKind.Toggle,
