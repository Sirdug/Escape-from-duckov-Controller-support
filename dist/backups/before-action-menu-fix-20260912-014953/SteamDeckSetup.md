...
right stick toward what you see on screen; the crosshair keeps a fixed distance from the duck
and sweeps at the same speed in every direction. Easing off the stick slows the turn for fine
adjustment rather than pulling the crosshair in. Let go to keep your direction. Hold L2 for
more controlled adjustments. R3 locks an enemy; press it again or push away to release.
