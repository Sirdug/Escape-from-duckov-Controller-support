...
namespace DuckovPad
{
    ...
    internal sealed class GameplayDriver
    {
        ...
        public void Update(CharacterInputControl control, InputManager inputManager, CharacterMainControl character, float deltaTime)
        {
            ...
            bool sprint = Pad.Held(buttons.Sprint) || Pad.Held(buttons.DeckSprint);
            ...
            if (Pad.Down(buttons.Interact) || Pad.Down(buttons.DeckInteract)) inputManager.Interact();
            ...
            if (Pad.Down(buttons.Reload) || Pad.Down(buttons.DeckReload))
            {
